...
class Aluno(Pessoa):
    ...
    prof_id = db.Column(db.Integer, db.ForeignKey(Professor.id_professor), nullable = False)
    ...
    # método para expressar a pessoa em forma de texto
    def __str__(self):
        return f"Aluno: {self.nome}, Endereco: {str(self.endereco)}, Treino {self.treino.tipo}, Objetivo: {self.objetivo}"
